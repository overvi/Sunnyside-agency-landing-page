    ...
    <>
      <main>
        ...
        <section>
          <article className="article flex article-flex">
            <div className="flow-content-large article-content-contain">
              ...
              <a className="epic-btn ff-fraunces uppercase" href="">
                learn More
              </a>
            </div>
            <div>
        ...
        <div className="flex  minor">
          <div className="flex bg-img albalo-header minor-headers-cont text-center">
            <div className="minor-headers">
              <h1 className=" ff-fraunces">Graphic design</h1>
              <p>
          ...
          <div className="bg-img porteghal-header ">
            <div className="flex bg-img  minor-headers-cont text-center">
              <div className="minor-headers">
                <h1 className=" ff-fraunces ">Photography</h1>
                <p>
        ...
        <section className="testemonials text-center flow-content">
          <h1 className="ff-fraunces uppercase light-gray testemonials-header letter-spacing">
            client testemonials
          </h1>
          <div className="grid">
            <div className="testemonial-profile flow-content-large">
              <img className="testemonial-pic" src={emily} alt="" />
              <p className="testemonial-description">
                We put our trust in Sunnyside and they delivered, making sure
                our needs were met and deadlines were always hit.
              </p>
              <div className="testemonial-footer">
                <p className="ff-fraunces">Emily R.</p>
                <p className="light-gray"> Marketing Director</p>
              </div>
            </div>
            <div className="testemonial-profile flow-content-large">
              <img className="testemonial-pic" src={thomas} alt="" />
              <p className="testemonial-description">
                Sunnyside’s enthusiasm coupled with their keen interest in our
                brand’s success made it a satisfying and enjoyable experience.
              </p>
              <div className="testemonial-footer">
                <p className="ff-fraunces">Thomas S.</p>
                <p className="light-gray"> Chief Operating Officer</p>
              </div>
            </div>
            <div className="testemonial-profile flow-content-large">
              <img className="testemonial-pic" src={jennie} alt="" />
              <p className="testemonial-description">
                Incredible end result! Our sales increased over 400% when we
                worked with Sunnyside. Highly recommended!
              </p>
              <div className="testemonial-footer">
                <p className="ff-fraunces"> Jennie F.</p>
                <p className="light-gray "> Business Owner</p>
              </div>
            </div>
          </div>
        </section>
      ...
      <footer>
        <div className="footer-cont flow-content-large flex">
          <img width="200px" src={logoFooter} alt="" />
          <ul className="flex footer-list">
            <li>About</li>
            <li>Services</li>
            <li>Projects</li>
          </ul>
          <div className="flex footer-icons-cont">
            <svg
